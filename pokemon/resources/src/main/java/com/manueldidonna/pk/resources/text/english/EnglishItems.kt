...
internal class EnglishItems : PokemonTextResources.Items {

    override fun getAllItems(version: Version): List<String> {
        require(version is Version.FirstGeneration) { "Not supported version: $version" }
        return firstGenItems
    }
    ...
    private val firstGenItems: List<String> by lazy {
        listOf(
            "(None)",
            "Master Ball",
            "Ultra Ball",
